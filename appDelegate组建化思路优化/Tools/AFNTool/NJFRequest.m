...
#import "NJFRequest.h"
#import "NJFInterfacedConst.h"
#import "NJF_NetWorkTool.h"

@implementation NJFRequest
...
+ (NSURLSessionTask *)requestWithURL:(NSString *)URL parameters:(NSDictionary *)parameter success:(NJFRequestSuccess)success failure:(NJFRequestFailure)failure
{
